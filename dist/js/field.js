...
Nova.booting(function (Vue, router) {
    ...
    Vue.component('index-nova-toggle', __webpack_require__(9));
    Vue.component('detail-nova-toggle', __webpack_require__(12));
    Vue.component('form-nova-toggle', __webpack_require__(15));
});
    ...
    _vm.editableIndex
      ? _c(
          ...
          [
            _c("toggle-button", {
              attrs: {
                id: _vm.sanitizedName,
                name: _vm.sanitizedName,
                value: _vm.value,
                labels: _vm.labelConfig,
                width: _vm.width,
                height: _vm.height,
                sync: true,
                color: _vm.colors,
      ...
      : _c("span", {
          staticClass: "inline-block rounded-full w-4 h-4",
          style: _vm.bgColor
        }),
    _vm._v(" "),
    _vm.label != null
      ? _c("span", { staticClass: "pl-2" }, [_vm._v(_vm._s(_vm.label))])
      : _vm._e()
  ])
}
var staticRenderFns = []
...
var render = function() {
  ...
  return _c("panel-item", { attrs: { field: _vm.field } }, [
    _c(
      ...
      [
        _c("span", {
          staticClass: "inline-block rounded-full w-4 h-4 mr-1",
          class: {
        ...
        _vm._v(" "),
        _vm.label != null ? _c("span", [_vm._v(_vm._s(_vm.label))]) : _vm._e()
      ]
    )
  ])
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        sanitizedName: function sanitizedName() {
